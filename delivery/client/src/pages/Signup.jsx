...
import { AccountCircle, AdminPanelSettings, PhoneCallback, Visibility, VisibilityOff } from '@mui/icons-material';
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
      ...
      if (validMatch){
        axios.post("http://localhost:8080/user/signup", { name, password: pwd, email, contactNumber, l_name, address})
        .then(res => {
