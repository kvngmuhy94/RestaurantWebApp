      ...
      <div className='bg-gradient-to-r from-indigo-500 to-sky-500  w-full h-full flex flex-col'>
        ...
        <div className="flex flex-col md:flex-row justify-evenly items-center h-half w-5/6 rounded-4xl gap-1 p-0 md:p-5 m-auto shadow-lg">
          ...
          <div className='w-full flex flex-col md:flex-row'>
            ...
            {/* form */}
            <div className='bg-slate-50 flex flex-col items-center py-5 px-1 rounded-3xl w-full md:w-1/2 shadow-md m-auto'>
            <button className='text-primaryDark p-2 rounded-xl hover:scale-110 bg-slate-200 hover:shadow-xl transition-all'
                    onClick={()=> navigate("/adminLogin")}>
                      Login As Admin
                    </button>
            <p ref={errRef} className={errMsg ? "block text-red-500" : "hidden"} aria-live="assertive">{errMsg}</p>
              <h2 className='font-bold text-2xl text-primary pb-5 mx-0 md:mx-3 uppercase'>User Login</h2>
