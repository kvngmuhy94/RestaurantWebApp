...
import { adminLinks, logo } from '../../constants';
    ...
    {activeMenu && (
      <>
        <div className="flex justify-between items-center">
          <Link to="/" onClick={handleCloseSideBar} className="items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight text-primary">
            <img src={logo}
               alt="logo"
               width={"100px"}
               height={"100px"}
